...
![LunarFox Banner](https://cdn.modrinth.com/data/r7CwLIIr/images/2e792de45ffdd41d8c1c8b59a804f3500ad1ab03.png)
...
LunarFox uses a series of mods to replace OptiFine's functionality. For a detailed list, please refer to [OptiFine Alternatives](https://optifine.alternatives.lambdaurora.dev/). If you don't want to install these mods manually, you can use the LunarFox modpack directly.
