...
- For non-Chinese communities, you can join our [Discord channel](#TODO_discord).

## 🧾 User Agreement and Disclaimer

By downloading and using this modpack, you unconditionally agree to the [LunarFox Modpack User Agreement and Disclaimer](/lunarfox/disclaimer).
