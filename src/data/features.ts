export const features = [
  {
    ...
    url: "https://modrinth.com/mod/g96Z4WVZ",
    description: {
      zh_CN: "专注于渲染之外的优化模组。",
  ...
  },
  {
    ...
    supported_version: [
      ...
      { version: "1.20.1", status: "deprecated" },
    ],
  },
  {
  ...
  {
    name: "FerriteCore",
    url: "https://modrinth.com/mod/uXXizFIs",
    description: {
      zh_CN: "减少内存使用。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/5ZwdcRci",
    description: {
      zh_CN: "加速和优化 Minecraft 中的即时模式渲染。",
  ...
  {
    name: "Noisium",
    url: "https://modrinth.com/mod/KuNKN7d2",
    description: {
      zh_CN: "优化世界生成性能以获得更好的游戏体验。",
      en_US: "Optimises worldgen performance for a better gameplay experience.",
    },
    supported_version: [
      { version: "1.21.5", status: "supported" },
      { version: "1.21.4", status: "supported" },
  ...
  {
    name: "FabricSkyBoxes/Nuit",
    url: "https://modrinth.com/mod/YBz7DOs8",
    description: {
      zh_CN: "为 MC 添加自定义天空盒支持。",
      en_US: "Adds custom skybox support to MC",
    },
    supported_version: [
      { version: "1.21.5", status: "unsupported" },
      { version: "1.21.4", status: "supported" },
  ...
  {
    name: "FabricSkyBoxes/Nuit Interop",
    url: "https://modrinth.com/mod/HpdHOPOp",
    description: {
      zh_CN: "为 MCPatcher/OptiFine 天空提供 FabricSkyBoxes 互操作性。",
      en_US: "FabricSkyBoxes Interoperability for MCPatcher/OptiFine Skies",
    },
    supported_version: [
      { version: "1.21.5", status: "unsupported" },
      { version: "1.21.4", status: "supported" },
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/yBW8D80W",
    description: {
      zh_CN: "Fabric 上最功能齐全的动态光照模组。",
  ...
  {
    name: "Zume",
    url: "https://modrinth.com/mod/o6qsdrrQ",
    description: {
      zh_CN: "Nolij 的一个简单缩放模组。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/axolotl-buckets",
    description: {
      zh_CN: "在桶中显示美西螈的颜色和年龄。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/n6PXGAoM",
    description: {
      zh_CN: "改进统计屏幕并使其更有用。",
  ...
  {
    name: "CalcMod",
    url: "https://modrinth.com/mod/XoHTb2Ap",
    description: {
      zh_CN: "在聊天中提供计算器功能，带有为 Minecraft 设计的快捷方式。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/aLcHfalx",
    description: {
      zh_CN: "可拖动的资源包、数据包、服务器和世界列表。",
      en_US: "Draggable resource packs, datapacks, servers and worlds.",
    },
    supported_version: [
      { version: "1.21.5", status: "supported" },
      { version: "1.21.4", status: "supported" },
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/ZcR9weSm",
    description: {
      zh_CN: "根据目标改变形状的动态准星。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/I7k4B65h",
    description: {
      zh_CN: "允许使用中文拼音搜索内容的模组。",
  ...
  {
    name: "Litematica",
    url: "https://modrinth.com/mod/bEpr0Arc",
    description: {
      zh_CN: "一个现代的原理图模组。",
  ...
  {
    name: "Masa Gadget",
    url: "https://modrinth.com/mod/qGUUhBWE",
    description: {
      zh_CN: "为 Masa 系列模组添加了一些功能。",
      en_US: "Added some features to the Masa collection of mods.",
    },
    supported_version: [
      { version: "1.21.5", status: "supported" },
      { version: "1.21.4", status: "supported" },
  ...
  {
    name: "Packet Fixer",
    url: "https://modrinth.com/mod/c7m1mi73",
    description: {
      zh_CN: "一个简单的模组，用于解决与数据包/NBT 的各种问题。",
  ...
  {
    name: "Peek",
    url: "https://modrinth.com/mod/TnOXNf5e",
    description: {
      zh_CN: "在物品工具提示中显示额外信息。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/ZX66K16c",
    description: {
      zh_CN: "在收集物品时收到通知。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/Bh37bMuy",
    description: {
      zh_CN: "Sodium 的替代选项菜单。",
  ...
  {
    name: "Resourcify",
    url: "https://modrinth.com/mod/RLzHAoZe",
    description: {
      zh_CN: "游戏内资源包、数据包和着色器浏览器。",
  ...
  },
  {
    ...
    url: "https://modrinth.com/mod/nfn13YXA",
    description: {
      zh_CN: "干净且可定制的。Just Enough Items/JEI 的替代品。",
  ...
  {
    name: "Sodium Extra",
    url: "https://modrinth.com/mod/PtjYWJkn",
    description: {
      zh_CN: "一个 Sodium 附加组件，添加不应该在 Sodium 中的功能。",
  ...
  {
    name: "Title Fixer",
    url: "https://modrinth.com/mod/8zYE8DiW",
    description: {
      zh_CN: "使 Minecraft 标题始终适合屏幕。",
  ...
  {
    name: "Tweakeroo",
    url: "https://modrinth.com/mod/t5wuYk45",
    description: {
      zh_CN: "添加大量可配置的客户端调整。",
  ...
  {
    name: "Xaero Plus",
    url: "https://modrinth.com/mod/xaeroplus",
    description: {
      zh_CN: "Xaero 世界地图/小地图额外功能。",
